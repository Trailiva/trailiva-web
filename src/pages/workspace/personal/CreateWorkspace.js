...
const CreateWorkspace = () => {
  ...
  const createWorkspace = async (e) => {
    e.preventDefault();
    try {
      let tagName = formData.name
        .charAt(0)
        .concat(formData.name.charAt(1))
        .toUpperCase();
      console.log(tagName);
      ...
      case 1:
        return (
          <div>
            ...
            <button className="next_btn" onClick={Continue}>
              Next
            </button>
          </div>
        );
        ...
        return (
          <div>
            ...
            <div className="step_btn">
              <button className="next_btn" onClick={Previous}>
                Prev
              </button>
              <button className="next_btn" onClick={Continue}>
                Next
  ...
  return (
    <div className="container">
      ...
      <div className="form_container">
        <form className="form_wrapper" noValidate onSubmit={createWorkspace}>
          {getForm()}
        </form>
      </div>
    </div>
